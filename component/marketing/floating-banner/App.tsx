...
export default function Component() {
  return (
    <div className="mx-1 my-2 flex w-full items-center justify-between rounded-large border-1 border-divider bg-gradient-to-r from-default-100 via-danger-100 to-secondary-100 px-6 py-2 sm:mx-2 sm:px-3.5 md:mx-4">
